package com.osipov.kameleoontrialtask.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.osipov.kameleoontrialtask.controller.*.*(..))")
    ...
    @After("execution(* com.osipov.kameleoontrialtask.controller.*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.osipov.kameleoontrialtask.*.*.*.*(..))", throwing = "ex")
